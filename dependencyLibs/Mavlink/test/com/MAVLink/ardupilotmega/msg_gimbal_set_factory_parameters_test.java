...
public byte[] generateTestPacket(){
    ...
    payload.putInt(963497464); //magic_1
    payload.putInt(963497672); //magic_2
    payload.putInt(963497880); //magic_3
    payload.putInt(963498088); //serial_number_pt_1
    payload.putInt(963498296); //serial_number_pt_2
    payload.putInt(963498504); //serial_number_pt_3
