package com.fuav.android.chat.db;
...
import com.fuav.android.chat.Constant;
...
public class DemoDBManager {
    ...
    private DemoDBManager(){
        dbHelper = DbOpenHelper.getInstance(DroidPlannerApp.getInstance().getApplicationContext());
    }
