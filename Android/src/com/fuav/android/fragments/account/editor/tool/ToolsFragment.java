...
import com.fuav.android.view.button.RadioButtonCenter;
 ...
 */
public class ToolsFragment extends ApiListenerFragment implements OnClickListener, SupportYesNoDialog.Listener {
    ...
    private final ToolsImpl[] editorToolsImpls = new ToolsImpl[EditorTools.values().length];

    {
        editorToolsImpls[EditorTools.MARKER.ordinal()] = new MarkerImpl(this);
        editorToolsImpls[EditorTools.DRAW.ordinal()] = new DrawImpl(this);
        editorToolsImpls[EditorTools.TRASH.ordinal()] = new TrashImpl(this);
        editorToolsImpls[EditorTools.SELECTOR.ordinal()] = new SelectorImpl(this);
        editorToolsImpls[EditorTools.NONE.ordinal()] = new NoneImpl(this);
    }
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            ...
            for (ToolsImpl toolImpl : editorToolsImpls)
    ...
    public void onAttach(Activity activity) {
        ...
        if (!(activity instanceof ToolListener)) {
            throw new IllegalStateException("Parent activity must be an instance of " + ToolListener.class
                    .getName());
        }

        listener = (ToolListener) activity;
    }
